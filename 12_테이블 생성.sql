...
- DATE -> BC 4712년 1월 1일 ~ AD9999년 12월 31일까지 지정 가능
- 시, 분, 초 지원가능.
*/
CREATE TABLE dept2(
    dept_no NUMBER(2),
...
INSERT INTO dept2
VALUES(400, '경영지원', '서울', sysdate, 2000000); --에러 NUMBER(2)
INSERT INTO dept2
VALUES(30, '영업부', '서울', sysdate, 20000000000); --에러 NUMBER(10)
INSERT INTO dept2
VALUES(30, '영업부인거같으면서인사도하고총무도하는부서', '서울', sysdate, 20000000000);
                                                    --에러 VARCHAR2(14) 
