...
SELECT dept3_seq.CURRVAL FROM dual;
ALTER SEQUENCE dept3_seq INCREMENT BY -32;
...
SELECT * FROM employees WHERE salary = 12008;  --f10 계획설명 볼수 있음
...
-- 인덱스 이름 변경    (tbl_board 에서 인덱스 조회해 봐야함.)
ALTER INDEX SYS_C007055
